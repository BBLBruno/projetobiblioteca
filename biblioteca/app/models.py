...
class Livro(models.Model):
    ...
    genero= models.ForeignKey(Genero, null=True, on_delete=models.CASCADE, verbose_name= 'Gênero')
    editora= models.ForeignKey(Editora, null=True, on_delete=models.CASCADE, verbose_name= 'Editora')
